...
var showstopper = {
  ...
  contractTargets: [
    ...
    "Auction bartender and stairs-walker Eric Hébert",
    "Auctioneer Nicolas Frank",
    "Stylist who wishes he had that jaw David Boyer",
...
var si = {
  ...
  contractTargets: [
    ...
    "Dancing master Toshimi 'Sandā no ashi' Kaneko (H2: Eric Sjövold)",
    ...
    "Nurse in the operating room Kimiho Ookawa (H2: Hanna Olsen)",
...
var tfl = {
  ...
  contractTargets: [
    ...
    "Sierra Knox",
    "Edward 'Ted' Mendez",
    "Nicholas Velmorres (Florida Man)",
    "Moses Lee",
...
var al = {
  ...
  contractTargets: [
    ...
    "Schmidt house plumber Dewitt Grammer"
  ],
  entry: [
    "Whittleton Creek",
    "Construction Area",
